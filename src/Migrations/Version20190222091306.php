 ...
 */
final class Version20190222091306 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE casting ADD person_id INT DEFAULT NULL, ADD movie_id INT DEFAULT NULL');
